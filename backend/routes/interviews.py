...
from backend.models import db, Interview, QAPair, EmotionLog
...
def save_interview():
    ...
    db.session.commit()
    return jsonify({"success": True, "message": "Interview saved successfully!", "interview_id": interview.id}), 201
...
def get_interview(interview_id):
    ...
    return jsonify({"success": True, "interview": interview.to_dict(include_qa=True)})
